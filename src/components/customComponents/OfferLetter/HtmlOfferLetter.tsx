...
//           <p className="mb-4">
//             This is to certify that <span className="font-bold"> {data.fullName}</span> Student of <span className="font-bold">{data.instituteName}</span> will be undergoing the Summer Internship Program on <span className="font-bold">"Develop High-End Next Generation End to End {data.courseTitle} Pipeline Managed Service in High Performance Cloud Computing Platform."</span> at LinuxWorld Informatics Pvt. Ltd. under the mentorship of The World Record Holder & CTO- <span className="font-bold">Mr. Vimal Daga</span>, for a period of <span className="font-bold">6 Month</span> as per the official college Curriculum.
//           </p>
